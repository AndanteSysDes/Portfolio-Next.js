...
import asukaImg from "@/public/asuka-img.png";
      ...
      <section className="space-y-6 pb-8 pt-6 mb-0 md:pb-12 md:py-20 lg:py-32 h-screen flex items-center">
        <div className="container flex max-w-[64rem] flex-col items-center gap-4 text-center -mt-20">
          <Image
            ...
            alt="Asuka Saito - Full Stack Developer Portfolio"
            priority
          />
          <AnimatedText
            as="h1"
          ...
          <div className="mt-4 max-w-[42rem] text-center">
            <p className="leading-normal text-muted-foreground text-sm sm:text-base">
              Self-motivated and adaptable software developer and business project leader, passionate about learning and applying new technologies. Experienced in full-cycle web and software development, project management, and entrepreneurship in multicultural environments.
            </p>
          </div>
          ...
          <div className="flex flex-col mt-10 items-center justify-center sm:flex-row sm:space-x-4 gap-3">
            <AnimatedText delay={0.6}>
              <Link
                href={"https://github.com/AndanteSysDes"}
                target="_blank"
                className={cn(buttonVariants({ size: "lg" }))}
                aria-label="View Asuka Saito's GitHub profile"
              >
            ...
            <AnimatedText delay={0.8}>
              <Link
                ...
                aria-label="Contact Asuka Saito"
              >
